...
import {TransDeployer} from "./TransDeployer.sol";

import {ITrans} from "./interfaces/ITrans.sol";
import {ITransVault} from "./interfaces/ITransVault.sol";
...
contract Trans is Ownable, ReentrancyGuard, ITrans {
        ...
        returns (address tokenAddress)
    {
        ...
        tokenAddress = TransDeployer.deployToken(tokenConfig, tokenAdmin, TOKEN_SUPPLY);
    }
        ...
        returns (address tokenAddress, uint256 positionId)
    {
        ...
        // deploy the token
        tokenAddress = TransDeployer.deployToken(
